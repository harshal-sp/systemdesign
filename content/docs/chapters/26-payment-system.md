...
description: "System design architecture and deep-dive analysis for Payment System"
---
...
<div style="margin-left:3rem">
    <img src="/images/chapters/26-payment-system/high-level-flow.png" alt="high-level-flow" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="/images/chapters/26-payment-system/payin-flow-high-level.png" alt="pay-in-flow-high-level" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="/images/chapters/26-payment-system/hosted-payment-page.png" alt="hosted-payment-page" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="/images/chapters/26-payment-system/hosted-payment-page-workflow.png" alt="hosted-payment-page-workflow" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="/images/chapters/26-payment-system/settlement-report.png" alt="settlement-report" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="/images/chapters/26-payment-system/single-receiver.png" alt="single-receiver" width="500" />
</div>

Multiple receivers - multiple receivers subscribe to the same topic, but messages are forwarded to all of them:

<div style="margin-left:3rem">
    <img src="/images/chapters/26-payment-system/multiple-receiver.png" alt="multiple-receiver" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="/images/chapters/26-payment-system/failed-payments.png" alt="failed-payments" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="/images/chapters/26-payment-system/retry-mechanism.png" alt="retry-mechanism" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="/images/chapters/26-payment-system/idempotency-example.png" alt="idempotency-example" width="500" />
</div>
