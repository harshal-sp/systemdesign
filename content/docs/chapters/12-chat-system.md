...
description: "System design architecture and deep-dive analysis for Chat System"
---
...
1. **Sender Side:** HTTP for sending messages, leveraging persistent connections for efficiency.
      ...
      <img src="/images/chapters/12-chat-system/basic-design.png" alt="Basic Design" width="500">    
      <div>
...
2. **Receiver Side:**
   - **Polling:**
      ...
      - Inefficient due to frequent, redundant requests.
         ...
         <img src="/images/chapters/12-chat-system/polling.png" alt="Polling" width="400">    

   - **Long Polling:** 
      - Keeps the connection open until messages arrive. 
      - Inefficient for inactive users.

         <img src="/images/chapters/12-chat-system/long-polling.png" alt="Long Polling" width="400">
   ...
   - **WebSocket:** 
      ...
      - Uses WebSockets (ws) protocol for sending and recieving messages.
         ...
         <img src="/images/chapters/12-chat-system/websocket.png" alt="Websocket"  width="400" >    
...
<div style="margin-left:5rem">
   <img src="/images/chapters/12-chat-system/high-level-stateless-arch.png" alt="High Level Architecture" height="350">    
   <img src="/images/chapters/12-chat-system/high-level-statefull-arch.png" alt="High Level Architecture" height="350" width="550">
</div>
...
<div style="margin-left:3rem">
      <img src="/images/chapters/12-chat-system/high-level-design.png" alt="High Level Design" width="450"> 
</div>
...
Following are the data models for one-to-one chat and group chat.
   ...
   - For the group chat the composite primary key is (channel_id, message_id). 
      ...
      <img src="/images/chapters/12-chat-system/one-to-one-chat.png" alt="One to one chat design" width="300">   
      <img src="/images/chapters/12-chat-system/group-chat.png" alt="Group chat design" width="300">   
...
<div style="margin-left:3rem">
   <img src="/images/chapters/12-chat-system/zookeeper.png" alt="Zookeeper" width="400">   
</div>
...
<div style="margin-left:3rem">
   <img src="/images/chapters/12-chat-system/group-chat-flow.png" alt="Group Chat Flow" width="400">  
</div>
...
<div style="margin-left:3rem">
   <img src="/images/chapters/12-chat-system/message-synchronization.png" alt="Message Synchronization"  width="400">  
</div>
...
1. **Heartbeat Mechanism:** 
   <div style="margin-left:3rem">
      <img src="/images/chapters/12-chat-system/heartbeat-mechanism.png" alt="Heartbeat Mechanism" width="400"> 
   </div>
...
2. **Fanout Model:** 
   ...
   <div style="margin-left:3rem">
      <img src="/images/chapters/12-chat-system/fanout-presence.png" alt="Fanout Presence" width="400"> 
   </div>
